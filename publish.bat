...
set TWITCH_API_PUB_DIR=%SCOREBINI_PUB_DIR%\twitch\%FW_NAME%
...
dotnet publish ScorebiniTwitchApi/ScorebiniTwitchApi.csproj -c Release -p:PublishProfile=FolderProfile -o %TWITCH_API_PUB_DIR%
